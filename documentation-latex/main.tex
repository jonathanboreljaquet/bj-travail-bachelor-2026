...
\newline
\textbf{4. Parameter Explanation} : Chaque paramètre est détaillé avec son type, sa signification, son effet sur le comportement de l'outil, et son statut (requis ou valeur par défaut).
\newline
