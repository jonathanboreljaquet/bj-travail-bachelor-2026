...
\item \textbf{API MeteoSwiss} : Système externe interrogé par l'Assistant IA pour valider les prévisions météorologiques avant la proposition d'un terrain en extérieur.
\end{itemize}\
\newline
