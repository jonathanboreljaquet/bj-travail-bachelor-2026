...
PadelConnect est une application disponible sur Android, IOS et sur le web, qui permet de réserver des terrains de padel à Genève, plus précisemment les terrains des quatres sites suivants : 
\newline
\begin{itemize}
    \item Centre sportif de Bernex 
    \begin{itemize}
        \item 2 terrain outdoor 
        \item Tout les jours de 07h30 à 22h30 
...
Analyse des applications PadelConnect et PlayPad, leurs fonctionnalités, leurs limites et pourquoi pas les retours utilisateurs.
