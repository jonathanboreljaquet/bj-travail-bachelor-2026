...
\end{table}
\subsection{Gantt}
Dans la continuté de la méthodologie MoSCoW, j'ai également réalisé une planification Gantt du projet. Cette planification m'a permis d'organiser et visualiser l'ensemble des tâches à réaliser, leur ordre chronologique et leur durée estimée. Elle m'a également permis d'identifier les dépendances entre les différentes tâches et à anticiper les éventuels retards ou obstacles qui pourraient survenir au cours du projet.
\newline\newline
