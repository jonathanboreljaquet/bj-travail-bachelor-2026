...
\begin{table}[H]
    ...
    \begin{tabular}{|c|S{p{9.5cm}}|l|c|}
        ...
        09 & Application mobile native (iOS / Android) & Could-have & 15\% \\ \hline
        10 & Outil MCP (Géolocalisation) : Filtrage avancé des terrains par coordonnées GPS et rayon de distance (en km) & Could-have & 5\% \\ \hline
        11 & Interface de messagerie instantanée entre les joueurs & Won't-have & - \\ \hline
        12 & Paiement intégré lors de la réservation d'un terrain & Won't-have & - \\ \hline
    \end{tabular}
...
Afin d'assurer l'échange de données entre les interfaces utilisateur et la base de données, tout en fournissant un point d'accès standardisé au serveur MCP, le développement d'une API s'est avéré indispensable. 
\newline\newline
Pour ce faire, il a d'abord fallu déterminer l'architecture d'API la plus adaptée aux contraintes du projet. Parmi les standards actuels les plus connus se trouvent les architectures SOAP, REST et GraphQL. Mon choix s'est naturellement porté sur l'architecture REST.
\newline\newline
Contrairement a l'architecure SOAP qui repose sur des messages XML et une structure de communication plus rigide, l'architecture REST prône la simplicité, une communication sans état et une architecture orientée sur les ressources. 
\newline\newline
...
Pourquoi j'ai choisis de réalaiser une base de données relationnelle. https://ieeexplore.ieee.org/document/8400041
Pourquoi j'ai choisis d'utiliser PostgreSQL
