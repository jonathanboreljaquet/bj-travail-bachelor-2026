...
\subsection{Choix de l'architecture de l'API}
...
\subsection{Choix du système de base de données}
...
\subsection{Choix de l'environnement, du framework et des outils backend}
